(function(){
/*
this file (core.js) is adopted from following repo:
...
qrcoder.svg = function(o){
  o == null && (o = {});
  return qrcoder.make(o);
};
qrcoder.make = function(o){
  var text, level, obj, count, list, size, dim, _, padding, round, delta, i$, y, j$, x, dark, px, ref$, py, _d, fill, color, _fc, svg;
  o == null && (o = {});
  text = typeof o === 'string'
    ? o
    : o.text || '';
  level = o.level != null
    ? o.level
  ...
  obj.addData(text);
  obj.make();
  count = obj.getModuleCount() || 1;
  list = [];
  size = o.size || 256;
  dim = o.viewBoxSize || 1000;
  _ = function(v){
    return v.toFixed(1).replace(/\.0$/, '');
  };
  padding = _(o.padding || 0) * dim;
  round = _(o.round || 0) * dim;
  ...
  for (i$ = 0; i$ < count; ++i$) {
    ...
    for (j$ = 0; j$ < count; ++j$) {
      ...
      px = _(x * delta + ((ref$ = x - 1) > 0 ? ref$ : 0) * padding) - 1;
      py = _(y * delta + ((ref$ = y - 1) > 0 ? ref$ : 0) * padding) - 1;
      _d = _(delta);
      fill = typeof o.color === 'function' ? o.color({
        x: x / (count - 1),
        y: y / (count - 1),
        dark: dark
      }) : null;
...
qrcoder.prototype = (ref$ = Object.create(Object.prototype), ref$.make = function(o){
  o == null && (o = {});
  return qrcoder.make(import$(typeof o === 'string' ? {
    text: o
  } : o, this._o));
}, ref$.svg = function(o){
  o == null && (o = {});
